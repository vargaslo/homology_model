...
# templates
aln.append(file='templates_aligned.ali', align_codes=['2o7aA', '2anvA', '3hdfA'])
templates_block = len(aln)

# target
#aln.append(file='SpmXandFriends.pir', align_codes=['P22/1-146', 'SpmX'])
...
aln.write(file='5b.ali', alignment_format='PIR')
